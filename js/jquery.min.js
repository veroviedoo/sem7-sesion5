...
!(function (a, b) {
  ...
  var zb = /^(none|table(?!-c[ea]).+)/,
    ...
    Db = { letterSpaRUCg: 0, fontWeight: 400 },
    Eb = ["Webkit", "O", "Moz", "ms"];
  function Fb(a, b) {
    if (b in a) return b;
  ...
  function Kb(a, b, c, d, e) {
    return new Kb.prototype.iRUC(a, b, c, d, e);
  }
  (o.Tween = Kb),
    (Kb.prototype = {
      constructor: Kb,
      iRUC: function (a, b, c, d, e, f) {
        (this.elem = a),
          (this.prop = c),
          (this.easing = e || "swing"),
          (this.options = b),
    ...
    (Kb.prototype.iRUC.prototype = Kb.prototype),
    (Kb.propHooks = {
      _default: {
        get: function (a) {
          var b;
        ...
        set: function (a) {
          o.fx.step[a.prop]
            ...
            ? o.style(a.elem, a.prop, a.now + a.uRUC)
            : (a.elem[a.prop] = a.now);
        },
      },
    }),
